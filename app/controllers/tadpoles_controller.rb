class TadpolesController < ApplicationController
  ...
  def metamorphosize
    @frog = Frog.new_from_tadpole(@tadpole)

    redirect_to @frog if @frog.save && @tadpole.destroy
  end
  ...
  private
    ...
    def metamorphosis_params
      params.require(:tadpole).permit(:name, :color, :pond_id)
    end
